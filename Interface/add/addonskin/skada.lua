...
Skadaskin:SetScript("OnEvent", function()
	...
	if IsAddOnLoaded("Skada") then
		...
		barmod.ApplySettings = function(self, win)
			...
			titlefont:SetFont(GameTooltipText:GetFont(), 14, "THINOUTLINE")
		...
		function EmbedSkada()
			if #windows == 1 then
				EmbedWindow(windows[1], 322, 15, 105, "BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -9, 29)
			elseif #windows == 2 then
				EmbedWindow(windows[1], 322, 15, 105,  "BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -9, 29)
				EmbedWindow(windows[2], 322, 15, 105,  "BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -340, 29)
			end
		end
		...
		if ChatRBGTab then
			...
			button:FontString(nil, GameTooltipText:GetFont(), 12, 'THINOUTLINE')

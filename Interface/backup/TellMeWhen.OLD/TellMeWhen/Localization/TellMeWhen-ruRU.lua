...
L["CHOOSENAME_EQUIVS_TOOLTIP"] = "Вы можете выбрать заранее определенный набор бафов/дебафов, заклинаний, уменьшений эффективности или типов рассеивания (Магии, Проклятия и т.д.) из этого меню для ввода в строку \"%s\"." -- Needs review
...
L["UIPANEL_FONT_Bind"] = "Текст Привязки/Ярлыка" -- Needs review
L["UIPANEL_FONT_Bind_DESC"] = "Содержит параметры настройки, которые управляют показом текста привязки/ярлыка на иконке." -- Needs review
...
L["UIPANEL_FONT_Count"] = "Текст для стака" -- Needs review
L["UIPANEL_FONT_Count_DESC"] = "Содержит параметры настройки, которые управляют показом текста стака на иконке." -- Needs review

...
L["ANIM_SIZE_ANIM"] = "Tamaño de Borde"
L["ANIM_SIZE_ANIM_DESC"] = "Establece cuánto de grande debería ser el borde entero. (El tamaño por defecto de un icono es 30.)"
...
L["BleedDamageTaken"] = "Incrementa Daño de Sangrado Recibido"
L["Bleeding"] = "Sangrando"
L["BonusAgiStr"] = "Agilidad/Fuerza Aumentadas"
L["BonusArmor"] = "Armadura Aumentada"
L["BonusMana"] = "Reserva de Maná Aumentada"
...
L["CHOOSENAME_EQUIVS_TOOLTIP"] = "Puede seleccionar conjuntos predefinidos de ventajas, desventajas, lanzamientos de hechizos, rendimientos decrecientes o tipos de disipación (Magia, Maldición, etc) desde este menú para insertarlos en el cuadro de de edición \"%s\""
...
L["CLEU_SPELL_CAST_SUCCESS"] = "Éxito en Lanzamiento Instantáneo de Hechizo"
L["CLEU_SPELL_CAST_SUCCESS_DESC"] = [=[Sucede cuando se lanza un hechizo instantáneo. 

NOTA: Antes de Mists of Pandaria, esto seguiría cualquier éxito en lanzamiento de hechizo. Ahora sólo sigue lanzamientos instantáneos. 

NOTA: Para prevenir potenciales abusos, Blizzard ha excluido la unidad destino de este evento, de modo que no puedes filtrar por ella.]=]
...
El temporizador está activo (inutilizable/presente),
%q está deshabilitado, 
Ambos ajustes %q no están marcados]=]
...
Si no quiere mostrar los iconos que se están comprobando, marque %q en el editor de iconos del icono que se está comprobando.

El grupo del icono que se está comprobando debe ser mostrado para comprobar el icono, incluso si la condición se establece como falsa]=] -- Needs review
...
L["Enraged"] = "Enfurecer"
L["ERROR_ACTION_DENIED_IN_LOCKDOWN"] = "No puede hacer esto en combate." -- Needs review
...
L["ERROR_NO_LOCKTOGGLE_IN_LOCKDOWN"] = "No se puede desbloquear TellMeWhen estando en combate." -- Needs review
...
L["ICONMENU_ALLOWGCD_DESC"] = "Marque esta opción para permitir al temporizador reaccionar a y mostrar el tiempo de reutilización global en vez de simplemente ignorarlo. " -- Needs review
...
|cFFFF5959IMPORTANTE|r: Los nombres de encantamientos deben introducirse exactamente como aparecen en el tooltip del arma mientras el encantamiento está activo (p.ej "%s", no "%s")]=] -- Needs review
...
L["ICONMENU_GHOUL"] = "Necrófago sin \"Maestro de los necrófagos\"" -- Needs review
L["ICONMENU_GHOUL_DESC"] = "Sigue a su necrófago si no dispone del talento %s." -- Needs review
...
L["ICONMENU_ICDTYPE"] = "Activado por"
...
L["ICONMENU_LIGHTWELL_DESC"] = "Sigue la duración y cargas de su Pozo de Luz" -- Needs review
...
L["ICONMENU_MOUSEOVERTARGET"] = "Objetivo de unidad bajo el ratón" -- Needs review
...
L["IncreasedDamage"] = "Daño Aumentado"
...
L["ManaRegen"] = "Regeneración de Maná Aumentada"
...
L["META_ADDICON_DESC"] = "Click para añadir otro icono a incluir en el meta icono. "
...
L["MOUSEOVER_TOKEN_NOT_FOUND"] = "<Nada bajo el ratón>" -- Needs review
...
L["PushbackResistance"] = "Resistencia al Retardo Aumentada"
...
L["ReducedAttackSpeed"] = "Velocidad de Ataque Reducida"
...
L["Resistances"] = "Resistencia a Hechizos Aumentada"
...
L["SpellCritTaken"] = "Crítico de Hechizo Recibido Aumentado"
...
(Borró el diseño? O importó este icono sin importar el diseño que usaba?)]=] -- Needs review
...
L["UIPANEL_FONT_Bind"] = "Texto de Etiqueta/Asignación"
L["UIPANEL_FONT_Bind_DESC"] = "Contiene ajustes que controlan la exposición del texto de enlace/etiqueta en los iconos."
...
L["UIPANEL_FONT_Count"] = "Texto de Acumulación"
L["UIPANEL_FONT_Count_DESC"] = "Contiene ajustes que controlan la exposición del texto de acumulación en los iconos. "

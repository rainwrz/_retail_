...
L.ArchiereusFlameInfo = "появляется внутри Святилища Ордоса. Игроки не имеющий легендарного плащя могут призвать его с помощью Свитка вызова у камея испытаний."

L.Rattleskew ="Косохрип"
L.RattleskewDrop ="Утраченная нога капитана Звездана"
L.RattleskewDrop2 ="Техника: символ скелета"
L.RattleskewInfo ="Подводный Кораблекрушение - Частичная лодке на дне морей \ nЕсли Капитан Звездан есть событие доступно. Вы можете присоединиться к его команде нежити и очистить корабль. Это порождает Косохрип"

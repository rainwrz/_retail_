...
DBM_CORE_OUT_OF_DATE_NAG				= "Your version of Deadly Boss Mods is out-of-date and you have elected to ignore popup notification. This is not recommended and could be a hinderance to yourself and your group on this fight. It is recommended you update so you are not missing an important alert or timer, or is missing a yell rest of raid is counting on seeing from you."

...
local BADBOY_LEVEL= 1 --1级小号
local good, maybe, badboy, filterTable, login = {}, {}, CreateFrame("Frame", "mg_Levels"), {}, nil
local whisp = "mg_Levels: You need to be level %d to whisper me."
...
ChatFrame_AddMessageEventFilter("CHAT_MSG_SYSTEM", function(_,_,msg)
	...
	if msg == ERR_FRIEND_LIST_FULL then
		print("|cFF33FF99mg_Levels|r: ", err) --print a warning if we see a friends full message
		return
	end

-- $Id: crafting.lua 4246 2013-09-10 08:38:03Z Dynaletik $
...
---- Jewelcrafting Daily
		...
		["Normal"] = {
			{
				...
				{ 2, "s145197", "101740", "=q1=Grand Pandaren Treasure Noodle Cart Kit", "=ds=#sr# 600", "=ds=", amount = 5};
				{ 3, "s145061", "101661", "=q1=Deluxe Noodle Cart Kit", "=ds=#sr# 600", "=ds=#QUESTID:33024#", amount = 5};
				{ 4, "s145170", "101729", "=q1=Grand Deluxe Noodle Cart Kit", "=ds=#sr# 600", "=ds=", amount = 5};
				{ 5, "s145038", "101630", "=q1=Noodle Cart Kit", "=ds=#sr# 600", "=ds=#QUESTID:33022#", amount = 5};
				{ 6, "s145167", "101727", "=q1=Grand Noodle Cart Kit", "=ds=#sr# 600", "=ds=", amount = 5};
				{ 7, "s105190", "74919", "=q1=Pandaren Banquet", "=ds=#sr# 600", "=ds=#QUESTID:31521#", amount = 5};
				{ 8, "s105194", "75016", "=q1=Great Pandaren Banquet", "=ds=#sr# 600", "=ds=#QUESTID:31521#", amount = 5};
				{ 9, "s125602", "87246", "=q1=Banquet of the Brew", "=ds=#sr# 575", "=ds="..ALIL["Way of the Brew"], amount = 5};
				{ 10, "s125603", "87248", "=q1=Great Banquet of the Brew", "=ds=#sr# 575", "=ds="..ALIL["Way of the Brew"], amount = 5};
				{ 11, "s125141", "87226", "=q1=Banquet of the Grill", "=ds=#sr# 575", "=ds="..ALIL["Way of the Grill"], amount = 5};
				{ 12, "s125142", "87228", "=q1=Great Banquet of the Grill", "=ds=#sr# 575", "=ds="..ALIL["Way of the Grill"], amount = 5};
				{ 13, "s125600", "87242", "=q1=Banquet of the Oven", "=ds=#sr# 575", "=ds="..ALIL["Way of the Oven"], amount = 5};
				{ 14, "s125601", "87244", "=q1=Great Banquet of the Oven", "=ds=#sr# 575", "=ds="..ALIL["Way of the Oven"], amount = 5};
				{ 15, "s125596", "87234", "=q1=Banquet of the Pot", "=ds=#sr# 575", "=ds="..ALIL["Way of the Pot"], amount = 5};
				{ 16, "s125597", "87236", "=q1=Great Banquet of the Pot", "=ds=#sr# 575", "=ds="..ALIL["Way of the Pot"], amount = 5};
				{ 17, "s125598", "87238", "=q1=Banquet of the Steamer", "=ds=#sr# 575", "=ds="..ALIL["Way of the Steamer"], amount = 5};
				{ 18, "s125599", "87240", "=q1=Great Banquet of the Steamer", "=ds=#sr# 575", "=ds="..ALIL["Way of the Steamer"], amount = 5};
				{ 19, "s125594", "87230", "=q1=Banquet of the Wok", "=ds=#sr# 575", "=ds="..ALIL["Way of the Wok"], amount = 5};
				{ 20, "s125595", "87232", "=q1=Great Banquet of the Wok", "=ds=#sr# 575", "=ds="..ALIL["Way of the Wok"], amount = 5};
				{ 22, "s88036", "62290", "=q1=Seafood Magnifique Feast", "=ds=#sr# 525", "#ACHIEVEMENTID:5036#"};
				{ 23, "s88011", "62289", "=q1=Broiled Dragon Feast", "=ds=#sr# 500", "#ACHIEVEMENTID:5467#"};
				{ 24, "s57423", "43015", "=q1=Fish Feast", "=ds=#sr# 450", "=ds="..AL["Vendor"]..": "..ALIL["Dalaran"]};
				{ 25, "s58527", "43478", "=q1=Gigantic Feast", "=ds=#sr# 425", "=ds="..AL["Vendor"]..": "..ALIL["Dalaran"]};
				{ 26, "s58528", "43480", "=q1=Small Feast", "=ds=#sr# 425", "=ds="..AL["Vendor"]..": "..ALIL["Dalaran"]};
				{ 27, "s45554", "34753", "=q1=Great Feast", "=ds=#sr# 375", "=ds="..AL["Trainer"]};
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 3, "s148256", "104047", "=q1=Glyph of Loud Horn", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
				{ 4, "s148257", "104048", "=q1=Glyph of Regenerative Magic", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
			...
			};
			{
				...
				{ 3, "s148266", "104099", "=q1=Glyph of the Skeleton", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Pandaria"] };
	...
	AtlasLoot_Data["Inscription_Druid"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 7, "s148269", "104103", "=q1=Glyph of One with Nature", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
				{ 8, "s148268", "104102", "=q1=Glyph of the Sprouting Mushroom", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
		...
		["Normal"] = {
			{
				...
				{ 4, "s148487", "104270", "=q1=Glyph of the Lean Pack", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
	...
	AtlasLoot_Data["Inscription_Mage"] = {
		["Normal"] = {
			...
			{
				{ 1, 0, "INV_Box_01", "=q6="..AL["Minor Glyph"], "" };
				{ 2, "s148272", "104106", "=q1=Glyph of Condensation", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Pandaria"] };
				{ 3, "s148271", "104105", "=q1=Glyph of Evaporation", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Pandaria"] };
		...
		["Normal"] = {
			{
				...
				{ 5, "s148260", "104051", "=q1=Glyph of Hand of Sacrifice", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
			...
			};
			{
				...
				{ 11, "s148273", "104107", "=q1=Glyph of the Exorcist", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Pandaria"] };
				{ 12, "s148274", "104108", "=q1=Glyph of Pillar of Light", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
	...
	AtlasLoot_Data["Inscription_Priest"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 13, "s148278", "104122", "=q1=Glyph of Inspired Hymns", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
	...
	AtlasLoot_Data["Inscription_Rogue"] = {
		["Normal"] = {
			...
			{
				{ 1, 0, "INV_Box_01", "=q6="..AL["Minor Glyph"], "" };
				{ 2, "s148279", "104123", "=q1=Glyph of Headhunting", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
				{ 3, "s148280", "104124", "=q1=Glyph of Improved Distraction", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
	...
	AtlasLoot_Data["Inscription_Shaman"] = {
		["Normal"] = {
			{
				{ 1, 0, "INV_Box_01", "=q6="..AL["Major Glyph"], "" };
				{ 2, "s148262", "104053", "=q1=Glyph of Eternal Earth", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
			...
			};
			{
				...
				{ 5, "s148287", "104133", "=q1=Glyph of Astral Fixation", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
				...
				{ 9, "s148288", "104134", "=q1=Glyph of Rain of Frogs", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
		...
		["Normal"] = {
			{
				...
				{ 3, "s148264", "104055", "=q1=Glyph of Impaling Throws", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Pandaria"] };
			...
			};
			{
				...
				{ 8, "s148289", "104135", "=q1=Glyph of the Raging Whirlwind", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
				{ 9, "s148290", "104136", "=q1=Glyph of the Subtle Defender", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Pandaria"] };
				{ 10, "s148291", "104137", "=q1=Glyph of the Watchful Eye", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Timeless Isle"] };
				{ 11, "s148292", "104138", "=q1=Glyph of the Weaponmaster", "=ds=#sr# 500", "=ds="..AL["Drop"]..": "..ALIL["Pandaria"] };

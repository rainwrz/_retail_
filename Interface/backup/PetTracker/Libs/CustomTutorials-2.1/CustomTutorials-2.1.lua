...
CustomTutorials is distributed under the terms of the GNU General Public License (Version 3).
...
local function NewFrame(data)
	local frame = CreateFrame('Frame', 'CustomTutorials'..Lib.numFrames, nil, 'ButtonFrameTemplate')

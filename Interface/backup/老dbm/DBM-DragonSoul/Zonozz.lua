...
local warnPsychicDrain			= mod:NewSpellAnnounce(104322, 4, nil, mod:IsTank()) --心靈吸取
...
function mod:SPELL_AURA_APPLIED(args)
	if args:IsSpellID(104378, 110322, 110306, 104377) and not phase2Started then--104378 confirmed 10 man normal, 110322 confirmed 25 man normal, 110306 confirmed 25 man heroic (doesn't appear as cast success, have to use applied)
		phase2Started = true
	...
	elseif args:IsSpellID(106836) then--106836 confirmed 10/25 man normal, do NOT add 103527 to this, that's a seperate spellid for when BOSS is affected by diffusion, this warning is counting the ball stacks.
		...
		if VDCount==1 then
			sndWOP:Schedule(0.5, "Interface\\AddOns\\DBM-Core\\extrasounds\\countone.mp3")
		elseif VDCount==2 then
			sndWOP:Schedule(0.5,"Interface\\AddOns\\DBM-Core\\extrasounds\\counttwo.mp3")
		elseif VDCount==3 then
			sndWOP:Schedule(0.5,"Interface\\AddOns\\DBM-Core\\extrasounds\\countthree.mp3")
		elseif VDCount==4 then
			sndWOP:Schedule(0.5,"Interface\\AddOns\\DBM-Core\\extrasounds\\countfour.mp3")
		elseif VDCount==5 then
			sndWOP:Schedule(0.5,"Interface\\AddOns\\DBM-Core\\extrasounds\\countfive.mp3")
		elseif VDCount==6 then
			sndWOP:Schedule(0.5,"Interface\\AddOns\\DBM-Core\\extrasounds\\countsix.mp3")
		elseif VDCount==7 then
			sndWOP:Schedule(0.5,"Interface\\AddOns\\DBM-Core\\extrasounds\\countseven.mp3")
		elseif VDCount==8 then
			sndWOP:Schedule(0.5,"Interface\\AddOns\\DBM-Core\\extrasounds\\counteight.mp3")
		elseif VDCount==9 then
			sndWOP:Schedule(0.5,"Interface\\AddOns\\DBM-Core\\extrasounds\\countnine.mp3")
		elseif VDCount==10 then
			sndWOP:Schedule(0.5,"Interface\\AddOns\\DBM-Core\\extrasounds\\countten.mp3")
		end
		VDCount=VDCount+1

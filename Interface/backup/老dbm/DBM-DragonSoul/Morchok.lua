	...
	if args:IsSpellID(103639) then
		if Ptwo then
			if args:GetSrcCreatureID() == 55265 and mod.Options.MorchokHero then
				...
				sndWOP:Schedule(9.8, "Interface\\AddOns\\DBM-Core\\extrasounds\\ex_ds_sjbz.mp3")--水晶爆炸
...
function mod:CHAT_MSG_MONSTER_YELL(msg)
	if (msg == L.Phtwo or msg:find(L.Phtwo)) and not Ptwo then
		Ptwo = true
		timerStompMK:Cancel()

--[[
	...
	Version: 8.1.6238 (SwimmingSeadragon)
	Revision: $Id: InfMain.lua 6238 2019-02-18 01:37:22Z none $
...
Informant_RegisterRevision("$URL: Informant/InfMain.lua $","$Rev: 6238 $")

INFORMANT_VERSION = "8.1.6238"

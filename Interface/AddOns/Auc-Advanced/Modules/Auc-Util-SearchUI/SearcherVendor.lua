--[[
	...
	Version: 8.1.6219 (SwimmingSeadragon)
	Revision: $Id: SearcherVendor.lua 6219 2019-02-18 01:37:22Z none $
...
function lib.Search(item)
	...
	local market = GetItemInfoCache(item[Const.ITEMID], 11)
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-SearchUI/SearcherVendor.lua $", "$Rev: 6219 $")

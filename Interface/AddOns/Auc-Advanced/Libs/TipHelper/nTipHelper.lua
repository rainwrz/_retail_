--[[
	...
	Version: 1,4
	Revision: $Id: nTipHelper.lua 6206 2019-02-18 01:37:22Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/TipHelper/nTipHelper.lua $","$Rev: 6206 $","5.12.DEV.", 'auctioneer', 'libs')

--[[
	...
	Version: 8.1.6241 (SwimmingSeadragon)
	Revision: $Id: Swatter.lua 6241 2019-02-18 01:37:22Z none $
...
LibStub("LibRevision"):Set("$URL: !Swatter/Swatter.lua $","$Rev: 6241 $","6.0.DEV.", 'auctioneer', 'libs')
